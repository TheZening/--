...
\newtcbtheorem[number within=section]
  {mdefinitioninner}{定义}
  {enhanced, breakable,
   colback=definitionC!5, colframe=definitionC,
   fonttitle=\bfseries}{def}
\NewDocumentEnvironment{mdefinition}{m o}
  {\IfNoValueTF{#2}
     {\begin{mdefinitioninner}{#1}{}}
     {\begin{mdefinitioninner}{#1}{#2}}}
  {\end{mdefinitioninner}}

% 总结环境
\newtcbtheorem[number within=section]
  {msummaryinner}{总结}
  {enhanced, breakable,
   colback=proofC!5, colframe=proofC,
   fonttitle=\bfseries}{prf}
\NewDocumentEnvironment{msummary}{m o}
  {\IfNoValueTF{#2}
     {\begin{msummaryinner}{#1}{}}
     {\begin{msummaryinner}{#1}{#2}}}
  {\end{msummaryinner}}
...
\newtcbtheorem[number within=section]
  {mexampleinner}{例子}
  {enhanced, breakable,
   colback=exampleC!5, colframe=exampleC,
   fonttitle=\bfseries}{ex}
\NewDocumentEnvironment{mexample}{m o}
  {\IfNoValueTF{#2}
     {\begin{mexampleinner}{#1}{}}
     {\begin{mexampleinner}{#1}{#2}}}
  {\end{mexampleinner}}
%==============================
...
\newcommand{\question}[1]{\textcolor{mypink}{#1}}
\newcommand{\newterm}[1]{\textcolor{definitionC}{#1}}
...
%==============================
\newpage
\input{GF_Classical.tex}
\newpage
\input{GF_KKRelation.tex}
\newpage
\input{GF_TIQM.tex}
\newpage
\input{GF_Propagator.tex}
\newpage
\input{GF_Spectrum.tex}
\newpage
\input{GF_Dyson.tex}
\newpage
\input{GF_SEandBroadening.tex}
\newpage
\input{GF_Examples.tex}
